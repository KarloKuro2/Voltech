    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            <div class="user text-center py-4">
                ...
                </a><a href="admin_approval_requests.php" class="list-group-item list-group-item-action bg-transparent second-text <?php echo $current_page == 'admin_approval_requests.php' ? 'active' : ''; ?>">
                    ...
                    <div class="col-md-3">
                        <div class="p-3 bg-white shadow d-flex justify-content-around align-items-center rounded card-link"
                            ...
                            <div>
                                ...
                                <p class="fs-5">Total Equipment (Owned)</p>
                            </div>
                    ...
                    <div class="col-md-3">
                        <div class="p-3 bg-white shadow d-flex justify-content-around align-items-center rounded card-link"
                            ...
                            <div>
                                ...
                                <p class="fs-5">Total Equipment (Rental)</p>
                            </div>
